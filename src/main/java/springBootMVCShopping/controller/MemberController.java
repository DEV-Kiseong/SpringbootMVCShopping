...
public class MemberController {
	...
	public String form(@Validated MemberCommand memberCommand, BindingResult result) {	
		...
		if(!memberCommand.isMemberPwEqualsMemberCon()) {
			result.rejectValue("memberPwCon", "errorCode", "비밀번호 확인이 틀렸습니다.");
			return "thymeleaf/member/memberForm";
		}else {
	...
	public String memberUpdate(@PathVariable(value="num")String memberNum, Model model) {
		memberDetailService.execute(memberNum, model);
	...
	public String memberDelete(@RequestParam(value="memberNum")String memberNum) {
